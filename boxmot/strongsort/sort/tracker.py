...
class Tracker:
    ...
    def __init__(self, metric, max_iou_dist=0.9, max_age=30, max_unmatched_preds=7, n_init=3, _lambda=0, ema_alpha=0.9, mc_lambda=0.995):
        ...
        self.max_age = max_age     # max_age帧未匹配就删除
        self.n_init = n_init
    ...
    def update(self, detections, classes, confidences):
        ...
        """
        # Run matching cascade.  matches(表示已经匹配成功的，eg: (0, 0))，
    ...
    def _match(self, detections):
        ...
        # Associate confirmed tracks using appearance features.（使用外观特征关联已确认的tracks）
