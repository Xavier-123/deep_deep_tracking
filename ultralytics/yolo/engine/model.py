...
from ultralytics import vit
from ultralytics.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel, RTDETRDetectionModel,
...
TASK_MAP = {
    ...
    'rtdetr_detect': [
        RTDETRDetectionModel, vit.rtdetr.RTDETRTrainer, vit.rtdetr.RTDETRValidator,
        vit.rtdetr.RTDETRPredictor],
    'segment': [
